...
function Header() {
  ...
  return (
    <header className='flex justify-between'>
      <Link to = {'/'} className='flex items-center gap-1 hover:scale-110 transition-transform duration-500'>
      ...
      <span className='font-bold text-xl text-primary'>S t a y Z y</span>
      </Link>
      <div className='flex border border-gray-300 rounded-full py-2 px-4 gap-2 shadow-md shadow-gray-300 items-center'>
        <div className='border-r-2'>
          <span className='hover:bg-gray-300 rounded-2xl px-2 py-1 duration-300'>Anywhere</span>
        </div>
        <div className='border-r-2'>
          <span className='hover:bg-gray-300 rounded-2xl px-2 py-1 duration-300'>Any week</span>
        </div>
        <div className='border-r-2'>
          <span className='hover:bg-gray-300 rounded-2xl px-2 py-1 duration-300'>Add guests</span>
        </div>
